...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() async {
    ...
    box.add('osman'); //index 0, key 0 value emre
    box.add('anar'); //index 1, key 1 value altunbilek
    box.add(true);
    ...
    await box.put('isim', 'osman');
    await box.put('isim', 'goktug');
  }

  void _customData() async {
    var osman = Ogrenci(5, 'osman', GozRenk.MAVI);
    var goktug = Ogrenci(15, 'goktug', GozRenk.YESIL);
